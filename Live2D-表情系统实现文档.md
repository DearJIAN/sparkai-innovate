...
> **📌 文档定位**：本文档是 [README.md](./README.md) 的技术补充文档，专注于详细解析平台中 **Live2D 虚拟形象「火花」** 的表情系统实现机制。如果你想了解项目整体概况，请先阅读 README.md；如果你想深入了解 AI 智能体的技术架构，请参阅 [AI-Agent功能分析报告.md](./AI-Agent功能分析报告.md)。
>
> 本文档详细阐述火花智创平台中 Live2D 虚拟形象「火花」的表情切换机制，特别关注控制面板点击触发、「水印」与「月卡」叠加效果的共存逻辑。
